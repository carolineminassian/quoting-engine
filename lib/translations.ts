export const translations = {
  US: {
    ...
    splitIntoInstallments: 'Installments',
    ...
    fillAllInstallments: 'Please fill in all amounts and dates.',
    installmentTotalMismatch: 'Total must equal the remaining balance.',
    selectStartDate: 'Please select a start date.',
    enterValidAmount: 'Please enter a valid amount.',
    recurringBillingSetup: 'Set Up Recurring Billing',
    recurringBillingSubtitle: 'Automatically generate invoices on a schedule',
    ...
    automatedRecurringBilling: 'Automated Recurring Billing',
    automatedRecurringBillingSetup: 'Set Up Automated Recurring Billing',
    automatedRecurringBillingSubtitle:
    ...
    regionalFormats: 'Regional Settings',
    defaultLanguage: 'Default Language',
    defaultCurrency: 'Default Currency',
    usFormatsLabel: 'United States',
    frFormatsLabel: 'France',
    ...
    enLangLabel: 'English (EN)',
    frLangLabel: 'Français (FR)',
    usdCurrencyLabel: 'US Dollar ($ - USD)',
    eurCurrencyLabel: 'Euro (€ - EUR)',
    stateLabel: 'State',
    stateShort: 'ST',
    ...
    billingRate: 'Billed of Approved',
    billingTrend: 'Billing Trend',
  ...
  FR: {
    ...
    splitIntoInstallments: 'Versements',
    recurringBilling: 'Récurrent',
    equalSplit: 'Fractions égales',
    ...
    fillAllInstallments: 'Veuillez renseigner tous les montants et les dates.',
    installmentTotalMismatch: 'Le total doit être égal au solde restant.',
    selectStartDate: 'Veuillez sélectionner une date de début.',
    enterValidAmount: 'Veuillez saisir un montant valide.',
    recurringBillingSetup: 'Configurer la facturation récurrente',
    recurringBillingSubtitle:
      'Générez automatiquement des factures selon un calendrier',
    amountPerPeriod: 'Montant par période',
    invoiceMode: 'Mode de facturation',
    draftMode: 'Brouillon',
    autoMode: 'Automatique',
    draftModeHint:
      "Un brouillon de facture sera créé à chaque période pour que vous puissiez le vérifier et l'envoyer.",
    autoModeWarning:
      'Les factures seront automatiquement finalisées et envoyées au client sans vérification.',
    billingDuration: 'Durée de facturation',
    indefinite: 'Indéfinie',
    fixedNumber: 'Nombre fixe',
    activateSchedule: 'Activer le calendrier',
    recurringSchedules: 'Calendriers récurrents',
    every: 'Tous les',
    nextRun: 'Prochain',
    active: 'Actif',
    paused: 'En pause',
    ...
    resume: 'Reprendre',
    deleteScheduleTitle: 'Supprimer le calendrier ?',
    deleteScheduleMessage:
      'Cela supprimera définitivement le calendrier de facturation récurrente. Les factures déjà créées ne seront pas affectées.',
    automatedRecurringBilling: 'Facturation Récurrente Automatisée',
    automatedRecurringBillingSetup:
      'Configurer la facturation récurrente automatisée',
    automatedRecurringBillingSubtitle:
      'Contrairement aux versements, la facturation récurrente génère automatiquement des factures selon un calendrier continu — sans configuration manuelle à chaque fois.',
    installmentModalSubtitle:
      'Fractionnez le solde restant en une série de paiements planifiés. Chaque versement devient sa propre facture.',
    ...
    enabled: 'Activé',
    disabled: 'Désactivé',
    regionalFormats: 'Format régional',
    defaultLanguage: 'Langue par défaut',
    defaultCurrency: 'Devise par défaut',
    usFormatsLabel: 'États-Unis',
    frFormatsLabel: 'France',
    themePreferenceLabel: 'Thème',
    lightTheme: 'Clair',
    darkTheme: 'Sombre',
    systemTheme: 'Système',
    ...
    enLangLabel: 'Anglais (EN)',
    frLangLabel: 'Français (FR)',
    usdCurrencyLabel: 'Dollar américain ($ - USD)',
    eurCurrencyLabel: 'Euro (€ - EUR)',
    ...
    outstandingAmount: 'En Attente',
    overdueAmount: 'En Retard',
    creditNotes: 'Avoirs',
    billingCollections: 'Facturation & Encaissements',
    collectionRate: "Taux d'Encaissement",
    billingRate: 'Facturé sur Approuvé',
    billingTrend: 'Tendance de Facturation',
